...
PEST 거시환경 분석을 수행하세요. FAW에서 식별한 사실(Facts)과 가정(Assumptions)을 거시환경 맥락에서 뒷받침하세요.
...
Porter's Five Forces 분석을 수행하세요. 각 세력의 강도를 1-5로 평가하세요. 3C의 경쟁사 분석과 일관되게 경쟁 강도를 평가하세요.
...
시장 분석 (TAM/SAM/SOM + 트렌드)을 수행하세요. PEST의 경제적·기술적 요인과 일관된 시장 규모를 산출하세요.
...
고객 분석 (세그먼트 + 페르소나)을 수행하세요. 3C의 고객(Customer) 분석을 구체화하되, 이전 결과와 모순되지 않도록 하세요.
...
경쟁사 프로파일링을 수행하세요. 3C의 경쟁사(Competitor)와 5Forces 결과를 기반으로 심층 분석하세요.
...
전략 캔버스 (Blue Ocean) 분석을 수행하세요. 경쟁 요인별 1-5 점수를 매기세요. 경쟁사 분석에서 도출된 동일한 경쟁사를 사용하세요.
...
Porter의 가치사슬 분석을 수행하세요. 3C의 자사(Company) 역량을 가치사슬 관점에서 구체화하세요.
...
McKinsey 7S 분석을 수행하세요. 가치사슬 분석의 조직 역량과 일관되게 평가하세요.
...
VRIO 분석을 수행하세요. 3C의 자사 역량과 가치사슬의 핵심 활동을 VRIO 관점에서 재평가하세요.
