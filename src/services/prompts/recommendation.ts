...
아래 전략 분석 프레임워크 목록에서 이 전략분석 아이템에 가장 적합한 프레임워크를 추천해 주세요.
...
분류 기준:
- essential: 이 전략분석 아이템에 반드시 필요한 핵심 프레임워크 (3~5개, score=100)
...
2. reason: 이 전략분석 아이템에 왜 이 프레임워크가 필요한지 구체적 사유 (아이템과 연결하여 설명)
